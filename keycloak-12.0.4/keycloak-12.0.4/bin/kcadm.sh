...
#else
#    java $KC_OPTS -cp $DIRNAME/client/keycloak-admin-cli-12.0.4.jar org.keycloak.client.admin.cli.KcAdmMain "$@" --noconfig --token $(kcinit token admin-cli) --server $(kcinit show server)
#fi
